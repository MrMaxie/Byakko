...
class App extends preact_1.default.Component {
    render() {
        ...
        x += 1;
        return preact_1.default.createElement("div", { class: "app", onClick: () => this.forceUpdate() }, "hello ", x, t);
    }
}
exports.default = App;
});
...
___scope___.file("_vars.scss", function(exports, require, module, __filename, __dirname){
