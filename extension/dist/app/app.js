...
const preact_1 = tslib_1.__importDefault(require("preact"));
const compat_1 = tslib_1.__importDefault(require("preact/compat/dist/compat.js"));
const mobx_react_1 = tslib_1.__importDefault(require("mobx-react"));
const App_1 = tslib_1.__importDefault(require("./App"));
require("./index.scss");
mobx_react_1.default.observerBatching({
    batchedUpdates: compat_1.default.unstable_batchedUpdates
});
const app = document.getElementById('app');
if (app) {
    preact_1.default.render(preact_1.default.createElement(App_1.default, null), app);
}
});
...
tslib_1.__decorate([mobx_1.observable, tslib_1.__metadata("design:type", Object)], Store.prototype, "isConnected", void 0);
tslib_1.__decorate([mobx_1.observable, tslib_1.__metadata("design:type", Object)], Store.prototype, "active", void 0);
tslib_1.__decorate([mobx_1.action, tslib_1.__metadata("design:type", Function), tslib_1.__metadata("design:paramtypes", [String]), tslib_1.__metadata("design:returntype", void 0)], Store.prototype, "setActive", null);
tslib_1.__decorate([mobx_1.observable, tslib_1.__metadata("design:type", typeof (_a = typeof Array !== "undefined" && Array) === "function" ? _a : Object)], Store.prototype, "msgs", void 0);
tslib_1.__decorate([mobx_1.action, tslib_1.__metadata("design:type", Function), tslib_1.__metadata("design:paramtypes", [Object]), tslib_1.__metadata("design:returntype", void 0)], Store.prototype, "pushMsg", null);
tslib_1.__decorate([mobx_1.action, tslib_1.__metadata("design:type", Function), tslib_1.__metadata("design:paramtypes", []), tslib_1.__metadata("design:returntype", void 0)], Store.prototype, "clear", null);
tslib_1.__decorate([mobx_1.action, tslib_1.__metadata("design:type", Function), tslib_1.__metadata("design:paramtypes", []), tslib_1.__metadata("design:returntype", void 0)], Store.prototype, "connect", null);
...
exports.default = mobx_react_1.observer(() => {
    if (!(globalSymbol in window) && false) {
        return preact_1.default.createElement("div", { class: "over-bg" }, preact_1.default.createElement("span", null, "Cannot connect with Byakko instance"), preact_1.default.createElement("span", { class: "try-again" }, "Click anywhere to try again..."));
    }
    const navItems = [{ name: 'Log', key: 'log' }, { name: 'Actions', key: 'actions' }, { name: 'Tasks', key: 'tasks' }, { name: 'Data', key: 'data' }].map(x => preact_1.default.createElement("div", { key: x.key, class: "tab", onClick: () => context.setActive(x.key), "data-is-active": context.active === x.key }, x.name));
    const msgs = context.msgs.map(x => JSON.stringify(x, null, 4));
    return preact_1.default.createElement("div", { class: "app" }, preact_1.default.createElement("div", { class: "nav" }, preact_1.default.createElement("div", { class: "logo" }, "Byakko"), navItems, preact_1.default.createElement("div", { class: "status", "data-is-connected": context.isConnected }, context.isConnected ? 'connected' : 'disconnected')), preact_1.default.createElement("pre", null, msgs));
});
});
